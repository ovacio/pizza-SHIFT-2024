...
import { RecipientAddress, InformationOrder } from '@/constants/interfaces';

const InformationOrderList = () => {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const { address, ...otherFormData } = formData;
...
export default InformationOrderList;
